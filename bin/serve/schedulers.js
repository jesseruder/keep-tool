...
function startSchedulers(ctx) {
  ...
  // CI on what was just pushed, in a child process: a red build goes to the session
  // that pushed it and reopens its card; the landed sweep holds a landing card until
  // CI is green.
  require('../ci-watch.js').startScheduler({ onChange: broadcast });
