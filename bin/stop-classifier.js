...
const INSTRUCTION = [
  ...
  'Options offered to the person for what to do next ("do X, or alternatively Y", "next: A, or B") are ASKS even when a check is scheduled or background work is running: the person picks.',
