...
const allowed = /^(?:bin|web|desktop|app|scripts|skills|docs|integrations|patches|tests|\.github)\/|^(?:README\.md|AGENTS\.md|CLAUDE\.md|LICENSE|\.gitignore|\.gitattributes|\.gitleaks\.toml|package(?:-lock)?\.json)$/;
const secrets = [
